...
namespace VidareutvecklaLabb3
{
    ...
    internal class Cappuccino : IWarmDrink
    {
        public void Consume()
        {
            Console.WriteLine("Enjoy your delicious cappuccino!"); // Utskrift vid konsumtion av vatten
        }
    }
    ...
    internal class HotChocolate : IWarmDrink
    {
        public void Consume()
        {
            Console.WriteLine("Enjoy your delicious hotchocolate!"); // Utskrift vid konsumtion av vatten
        }
    }
    ...
    internal class CoffeeFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Brew {total} ml of coffee"); // Utskrift av mängden kaffe som bryggs
    ...
    internal class CappuccinoFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Brew {total} ml of espresso"); // Utskrift av mängden espresso som bryggs
            Console.WriteLine("Steam and froth milk for cappuccino");
    ...
    internal class HotChocolateFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Melt {total} grams of chocolate"); // Utskrift av mängden choklad som smälts
            Console.WriteLine("Add milk and other ingredients for hot chocolate");
    ...
    public class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            RegisterFactory<HotChocolateFactory>("HotChocolate"); //Registrerar fabriken för varmchoklad
        }
